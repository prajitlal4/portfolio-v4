...
const plumberContent = {
  tradeName: 'Plumbers',
  headline: 'Websites for Plumbers',
...
export default function PlumbersPage() {
  useEffect(() => {
    const breadcrumbSchema = generateBreadcrumbSchema([
      ...
      { name: 'Websites for Plumbers', url: '/services/websites-for-plumbers' },
    ]);

    const faqSchema = {
      '@context': 'https://schema.org',
      '@type': 'FAQPage',
      mainEntity: plumberContent.faqs.map((faq) => ({
        '@type': 'Question',
        name: faq.question,
        acceptedAnswer: {
          '@type': 'Answer',
  ...
  return (
    <main className="bg-light min-h-screen">
      ...
      <Header
        ...
        imageUrl={null}
      />
      <TradeServiceTemplate {...plumberContent} showHero={false} showCTA={false} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-lg sm:text-xl text-dark-200 leading-relaxed mb-8">
                Here's something most plumbers don't know: your website and your Google Business Profile work together. When someone searches "plumber near me" or "plumber in [suburb]," Google looks at both to decide if you show up in the map results.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-xl font-bold font-heading text-dark mb-3">Why it matters for plumbers</h3>
                  <p className="text-lg text-dark-200 leading-relaxed">
                    Most of your customers find you through local searches. "Emergency plumber Perth," "hot water plumber Fremantle," "blocked drain Joondalup." If your Google Business Profile isn't set up properly or if you don't have a website linked to it, you're invisible for these searches.
                  </p>
                </div>
